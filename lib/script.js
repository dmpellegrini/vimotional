...
// Handles key strokes during gameplay
...
function keyChk (keyStroke,direction) {
  ...
  if (
    (keyStroke === "h" && direction === 'move_left') ||
    (keyStroke === "j" && direction === 'move_down') ||
    (keyStroke === "k" && direction === 'move_up') ||
    (keyStroke === "l" && direction === 'move_right') 
  ) {
    awrdPnts()
  }else{
    sbtrctPnts()
